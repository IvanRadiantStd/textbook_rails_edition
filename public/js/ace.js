(function() {
    ...
    (function() {
        r.implement(this, d), this.setKeyboardHandler = function(e) {
            ...
            if (!this.selection.isEmpty()) r = this.session.remove(this.getSelectionRange()), this.clearSelection();
            ...
            if (!(t.start.row < t.end.row || t.start.column < t.end.column)) {
                ...
                if (this.session.getUseSoftTabs()) {
                    var i = e.getTabSize(),
                        ...
                        u = e.documentToScreenColumn(o.row, o.column),
                        a = i - u % i;
                    r = s.stringRepeat(" ", a)
                } else r = "	";
    ...
    var r = e("../lib/event"),
        ...
        a = function(e, t) {
            ...
            var L = !1,
                A = function(e) {
                    k && (e = k(e), k = null), c ? (b(), e && t.onPaste(e), c = !1) : e == a[0] ? L && t.execCommand("del", {
                        source: "ace"
                    }) : (e.substring(0, 2) == a ? e = e.substr(2) : e[0] == a[0] ? e = e.substr(1) : e[e.length - 1] == a[0] && (e = e.slice(0, -1)), e[e.length - 1] == a[0] && (e = e.slice(0, -1)), e && t.onTextInput(e)), L && (L = !1)
                },
                O = function(e) {
                    if (h) return;
                    var t = n.value;
    ...
    (function() {
        this.onMouseDown = function(e) {
            ...
            this.dragSelectionMarker = e.session.addMarker(this.dragRange, "ace_selection", t), e.clearSelection(), r.addCssClass(e.container, "ace_dragging"), this.$dragKeybinding || (this.$dragKeybinding = {
    ...
    (function() {
        ...
        r.implement(this, o), this.setDocument = function(e) {
            ...
            while (c <= t) {
                ...
                if (!f) a = this.$getDisplayTokens(i.stringTrimRight(n[c])), s[c] = this.$computeWrapSplits(a, o, r), c++;
                else {
        ...
        this.tokenRe = new RegExp("^[" + o.packages.L + o.packages.Mn + o.packages.Mc + o.packages.Nd + o.packages.Pc + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + o.packages.L + o.packages.Mn + o.packages.Mc + o.packages.Nd + o.packages.Pc + "\\$_]|s])+", "g"), this.getTokenizer = function() {
            ...
            if (!this.lineCommentStart) {
                ...
                var f = this.blockComment.start,
                    l = this.blockComment.end,
                    c = new RegExp("^(\\s*)(?:" + u.escapeRegExp(f) + ")"),
                    h = new RegExp("(?:" + u.escapeRegExp(l) + ")\\s*$"),
                    p = function(e, t) {
                        if (v(e, t)) return;
                    ...
                    d = function(e, t) {
                        var n;
                        (n = e.match(h)) && i.removeInLine(t, e.length - n[0].length, e.length), (n = e.match(c)) && i.removeInLine(t, n[1].length, n[0].length)
                    },
                    v = function(e, n) {
                ...
                if (Array.isArray(this.lineCommentStart)) var c = this.lineCommentStart.map(u.escapeRegExp).join("|"),
                    f = this.lineCommentStart[0] + " ";
                else var c = u.escapeRegExp(this.lineCommentStart),
                    f = this.lineCommentStart + " ";
                c = new RegExp("^(\\s*)(?:" + c + ") ?");
                var d = function(e, t) {
                        var n = e.match(c);
                        n && i.removeInLine(t, n[1].length, n[0].length)
                    },
                    p = function(e, t) {
                        (!s || /\S/.test(e)) && i.insertInLine({
                            row: t,
                            column: a
                        }, f)
                    },
            ...
            m(function(e, t) {
                var n = e.search(/\S/);
                n !== -1 ? (n < a && (a = n), o && !v(e, t) && (o = !1)) : g > e.length && (g = e.length)
            }), a == Infinity && (a = g, s = !1, o = !1), m(o ? d : p)
    ...
    function u() {
        this.getFoldAt = function(e, t, n) {
            ...
            for (var r = 0; r < t.length; r++)
                for (var i = 0; i < t[r].folds.length; i++) n(t[r].folds[i]);
            return e
            ...
            if (t) this.removeFolds(i);
                ...
                while (i.length) this.expandFolds(i), i = this.getFoldsInRange(n)
            ...
            if (o) {
                ...
                if (l.range) var c = l.range.start.row + 1,
                    h = l.range.end.row;
    ...
    t.commands = [{
        ...
        name: "backspace",
        bindKey: s("Command-Backspace|Option-Backspace|Shift-Backspace|Backspace", "Ctrl-Backspace|Command-Backspace|Shift-Backspace|Backspace|Ctrl-H"),
        exec: function(e) {
            e.remove("left")
        },
        multiSelectAction: "forEach"
    ...
    var r = e("./lib/oop"),
        ...
        f = e("./layer/marker").Marker,
        l = e("./layer/text").Text,
        c = e("./layer/cursor").Cursor,
        h = e("./scrollbar").ScrollBar,
    ...
    var m = function(e, t) {
        ...
        this.canvas = r.element, this.$markerFront = new f(this.content), this.$cursorLayer = new c(this.content), this.$horizScroll = !1, this.scrollBar = new h(this.container), this.scrollBar.addEventListener("scroll", function(e) {
            ...
            offset: 0,
            height: 1
        }, this.$loop = new p(this.$renderChanges.bind(this), this.container.ownerDocument.defaultView), this.$loop.schedule(this.CHANGE_FULL), this.updateCharacterSize(), this.setPadding(4), u.resetOptions(this), u._emit("renderer", this)
    };
    (function() {
        this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, r.implement(this, d), this.updateCharacterSize = function() {
            ...
            var e = this.session,
                ...
                i = this.$hScrollBarAlwaysVisible || this.$size.scrollerWidth - r < 0,
                s = this.$horizScroll !== i;
            ...
            var u = Math.ceil(n / this.lineHeight) - 1,
                a = Math.max(0, Math.round((this.scrollTop - t) / this.lineHeight)),
                f = a + u,
                l, c, h = this.lineHeight;
            a = e.screenToDocumentRow(a, 0);
            var p = e.getFoldLine(a);
            p && (a = p.start.row), l = e.documentToScreenRow(a, 0), c = e.getRowLength(a) * h, f = Math.min(e.screenToDocumentRow(f, 0), e.getLength() - 1), n = this.$size.scrollerHeight + e.getRowLength(f) * h + c, t = this.scrollTop - l * h, this.layerConfig = {
                width: r,
            ...
            }, this.$gutterLayer.element.style.marginTop = -t + "px", this.content.style.marginTop = -t + "px", this.content.style.width = r + 2 * this.$padding + "px", this.content.style.height = n + "px", s && this.onResize(!0)
            ...
            if (this.$animatedScroll) {
                ...
                this.$scrollAnimation = {
                    from: e,
                    to: n
                }, clearInterval(this.$timer), r.session.setScrollTop(i.shift()), this.$timer = setInterval(function() {
            ...
            function r(e) {
                ...
                var n = e.padding || 4;
                t.$padding && n != t.$padding && t.setPadding(n), t.$size && (t.$size.width = 0, t.onResize()), t._dispatchEvent("themeLoaded", {
                    theme: e
                })
            }
            var t = this;
            this.$themeValue = e, t._dispatchEvent("themeChange", {
                theme: e
            });
    ...
    }).call(m.prototype), u.defineOptions(m.prototype, "renderer", {
        animatedScroll: {
            initialValue: !1
        },
        showInvisibles: {
    ...
    (function() {
        r.implement(this, u), this.EOF_CHAR = "¶", this.EOL_CHAR = "¬", this.TAB_CHAR = "→", this.SPACE_CHAR = "·", this.$padding = 0, this.setPadding = function(e) {
            ...
            if (!this.$measureNode) {
                ...
                if (this.element.ownerDocument.body) this.element.ownerDocument.body.appendChild(t);
                else {
            ...
            if (this.displayIndentGuides) {
                ...
                } else var i = s.stringRepeat(" ", this.tabSize),
                    o = i;
            ...
            for (;;) {
                ...
                if (this.$useLineGroups()) a.className = "ace_line_group", r.appendChild(a);
                else {
                    var l = a.childNodes;
        ...
        function() {
            this.ranges = null, this.rangeList = null, this.addRange = function(e, t) {
                ...
                this._emit("removeRange", {
                    ranges: e
                }), this.rangeCount == 0 && this.inMultiSelectMode && (this.inMultiSelectMode = !1, this._emit("singleSelect"), this.session.$undoSelect = !0, this.rangeList.detach(this.session)), t = t || this.ranges[0], t && !t.isEqual(this.getRange()) && this.fromOrientedRange(t)
    ...
    var r = e("../lib/oop"),
        ...
        o = function(t, n, r) {
            ...
            var i;
            if (s.get("packaged")) i = s.moduleUrl(n, "worker");
            else {
